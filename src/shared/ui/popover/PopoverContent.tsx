...
import {
  Portal as PopoverRadixPortal,
  Content as PopoverRadixContent,
...
export default function PopoverContent({
  ...
  sideOffset = 4,
  ...props
}: React.ComponentProps<typeof PopoverRadixContent>) {
  return (
    <PopoverRadixPortal>
      <PopoverRadixContent
